...
var add_comment_btn = document.getElementById('show-or-hide-form');
var div_ckeditor = document.getElementById('container-ckeditor');

add_comment_btn.onclick = function () {
  if (div_ckeditor.style.display !== "block") {
    div_ckeditor.style.display = "block";
  } else {
    div_ckeditor.style.display = "none";
  }
};

var comment_icon_btn = document.getElementById('show-or-hide-comments')
var div_comment = document.getElementById('container-comments')
var div_interactions = document.getElementById('interactions')

comment_icon_btn.onclick = function () {
  if (div_comment.style.display !== "block") {
    div_comment.style.display = "block";
    div_interactions.style.marginBottom = "0rem"

  } else {
    div_comment.style.display = "none";
    div_interactions.style.marginBottom = "2rem"
